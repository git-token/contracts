...
contract('GitToken', function(accounts) {
  describe("GitToken::getRewardDetails", function() {
    ...
    it("Should return reward and reserve values (250 * Math.pow(10, decimals), 0) for `milestone` and `created` GitHub web hook event and action", function() {
      return initContract().then(function(gittoken) {
